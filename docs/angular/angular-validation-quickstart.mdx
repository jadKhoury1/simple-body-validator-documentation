...
title: Angular Validation Quickstart
---
...
export class AppComponent implements OnInit {
    ...
    errors: ErrorBag = this.validator.errors();
...
We will consider that you already started with the basic example [above](/angular/angular-validation-quickstart#basic-example), and we will take things from there.

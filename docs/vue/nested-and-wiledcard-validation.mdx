...
![Example banner](/img/form-components.jpg)
...
:::caution
You are not bounded to vue <code>reactive</code> function for the state management, you can manage state the way it fits you the most.
:::
...
The **index** will be used to identify the appropriate error message associated with each address.
...
of the <code>rules</code> object, and we replaced <code>*</code> by the the array index.
